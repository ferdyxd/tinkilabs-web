            ...
            <div className="grid gap-6 sm:grid-cols-2">
              {suscripcionesCards.map((card) => (
                <div key={card.nombre}>
                  {card.activo ? (
                    <Link href={card.link}
                      className="group flex items-start gap-5 rounded-xl border border-neutral-100 p-5 transition-all duration-200 hover:border-tinki-orange/20 hover:bg-tinki-orange/[0.06] hover:shadow-md hover:shadow-tinki-orange/5"
                    >
                      ...
                      <div className="min-w-0 flex-1 pt-0.5">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="rounded-md bg-tinki-orange/10 px-1.5 py-0.5 text-xs font-semibold text-tinki-orange">{card.edad}</span>
                        </div>
                        <p className="mt-1.5 text-sm leading-relaxed text-tinki-dark/45">{card.subtitulo}</p>
                        <span className="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-tinki-orange transition-transform group-hover:translate-x-0.5">
                          Ver planes
                    ...
                    <div className="flex items-start gap-5 rounded-xl border border-neutral-100 p-5 opacity-50 cursor-not-allowed">
                      ...
                      <div className="min-w-0 flex-1 pt-0.5">
                        ...
                        <p className="mt-1.5 text-sm leading-relaxed text-tinki-dark/45">{card.subtitulo}</p>
                        <span className="mt-2 inline-block rounded-md border border-tinki-orange/20 bg-tinki-orange/5 px-2 py-0.5 text-xs font-semibold text-tinki-orange">Próximamente</span>
                      </div>
                    </div>
                  )}
                </div>
